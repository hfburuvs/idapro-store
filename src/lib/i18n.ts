...
export const translations: Record<CountryCode, Record<string, string>> = {
  ...
  es: {
    ...
    aboutStory: "Fundada con pasion por la tecnologia y la proteccion, iDaPro comenzo como una pequena empresa dedicada a resolver un problema comun: mantener nuestros queridos dispositivos a salvo del desgaste diario. Lo que comenzo como una busqueda del protector de pantalla perfecto ha evolucionado hasta convertirse en una completa linea de accesorios premium para smartwatches, camaras y dispositivos moviles. Creemos que la proteccion nunca debe comprometer el estilo ni la funcionalidad. Cada producto de nuestro catalogo se prueba y selecciona meticulosamente para garantizar que cumpla con nuestros altos estandares de calidad, durabilidad y experiencia de usuario.",
